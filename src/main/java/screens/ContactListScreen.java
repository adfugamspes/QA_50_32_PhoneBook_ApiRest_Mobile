...
//    }
    ...
    public void deleteContactMiddle() {
        new WebDriverWait(driver, Duration.ofSeconds(2)).until(ExpectedConditions.visibilityOf(btnAddContact));
        swipeScreen(driver, Direction.RIGHT);
        btnYes.click();
    }

    public void deleteFirstContact_CW() {
        new WebDriverWait(driver, Duration.ofSeconds(2)).until(ExpectedConditions.visibilityOf(btnAddContact));
        swipeInsideElement(driver, Direction.RIGHT, contactListScreen.get(0));
        btnYes.click();
    }

    public void editFirstContact(Contact contact){
        new WebDriverWait(driver, Duration.ofSeconds(2)).until(ExpectedConditions.visibilityOf(btnAddContact));
        swipeInsideElement(driver, Direction.LEFT, contactListScreen.get(0));
    ...
    public boolean isContactListEmpty(){
       return isElementPresent(noContacts, 5);
    }
}
